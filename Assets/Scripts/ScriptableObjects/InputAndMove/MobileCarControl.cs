...
[CreateAssetMenu(fileName = "MoveCarMobile", menuName = "CarControl/MoveCarMobile")]
public class MobileCarControl : MoveMethod
{
    public float torque;
    private bool isEndMove = false;
    [SerializeField]
    private Vector3 newForge;
    public override void Move(Transform m_transform, Rigidbody eventdata, Object player)
    {
        ...
        eventdata.AddForce(newForge,ForceMode.Impulse);
